...
class Design{
  final primaryColor = Color.fromRGBO(185, 211, 251, 1);
  final secondaryColor = Color.fromRGBO(231,238,253,1);
  final primaryButton = Color.fromRGBO(255, 236, 185, 1);
  final secondaryButton = Color.fromRGBO(236, 157, 171, 1);
  final submitButton = Color.fromRGBO(180, 248, 200, 1);
